    ...
    private void setupImageClassifier() {
        ...
        switch (currentModel) {
            case MODEL_MOBILENETV1:
                modelName = "mobilenet_v1_1.0_224_quantized_1_metadata_1.tflite";
                break;
            case MODEL_EFFICIENTNETV0:
                modelName = "efficientnet_lite0_int8_2.tflite";
                break;
            case MODEL_EFFICIENTNETV1:
                modelName = "efficientnet_lite1_int8_2.tflite";
                break;
            case MODEL_EFFICIENTNETV2:
                modelName = "efficientnet_lite2_int8_2.tflite";
                break;
            default:
                modelName = "mobilenet_v1_1.0_224_quantized_1_metadata_1.tflite";
        }
